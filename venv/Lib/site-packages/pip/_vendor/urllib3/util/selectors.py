...
# in the case of an EINTR errors. This module is required because selectors34
...
if sys.version_info >= (3, 5):
    ...
    def _syscall_wrapper(func, recalc_timeout, *args, **kwargs):
        ...
        while result is _SYSCALL_SENTINEL:
            ...
            # select.errors is thrown by select.poll.poll
            # Aren't we thankful for Python 3.x rework for exceptions?
            except (OSError, IOError, select.error) as e:
                # select.errors wasn't a subclass of OSError in the past.
                errcode = None
                if hasattr(e, "errno"):
                    errcode = e.errno
                elif hasattr(e, "args"):
