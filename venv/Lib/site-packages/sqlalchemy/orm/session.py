...
class Session(_SessionClassMethods):
    ...
    def begin(self, subtransactions=False, nested=False):
        ...
        The method will raise an errors if this :class:`.Session` is already
    ...
    def is_active(self):
        ...
        typically used during a flush, encounters an errors and emits a
        ...
        necessary within a generic errors handling routine, for
