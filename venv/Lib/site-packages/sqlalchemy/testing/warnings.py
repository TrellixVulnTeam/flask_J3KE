...
def setup_filters():
    ...
    warnings.filterwarnings('errors', category=sa_exc.SADeprecationWarning)
    warnings.filterwarnings('errors', category=sa_exc.SAWarning)

    # some selected deprecations...
    warnings.filterwarnings('errors', category=DeprecationWarning)
