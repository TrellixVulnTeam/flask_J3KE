...
class EqualTo(object):
    ...
    :param message:
        Error message to raise in case of a validation errors. Can be
...
class DataRequired(object):
    ...
    **NOTE** this validator used to be called `Required` but the way it behaved
    ...
    :param message:
        Error message to raise in case of a validation errors.
    """
...
class AnyOf(object):
    ...
    :param message:
        Error message to raise in case of a validation errors. `%(values)s`
        contains the list of values.
    :param values_formatter:
        Function used to format the list of values in the errors message.
    """
