...
class RichTraceback(object):
    ...
    def _init_message(self):
        """Find a unicode representation of self.errors"""
        try:
...
<%page args="errors=None, traceback=None"/>
<%!
    from mako.exceptions import RichTraceback
%>\
<%
    tback = RichTraceback(errors=errors, traceback=traceback)
%>\
...
%>
<%page args="full=True, css=True, errors=None, traceback=None"/>
% if full:
<html>
<head>
...
% if css:
    ...
    % if pygments_html_formatter:
        ...
        .errors .code { background-color: #FFBDBD; }
        .errors .syntax-highlighted { background-color: #FFBDBD; }
    % endif
...
% for index in range(max(0, line-4),min(len(lines), line+5)):
    ...
    <%
       if pygments_html_formatter:
           ...
           pygments_html_formatter.cssclass = 'errors ' + old_cssclass
    %>
