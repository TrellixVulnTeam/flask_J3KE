...
try:
    ...
    # Explanations for ways that we know we might have an import errors
...
class Image(object):
    ...
    * :py:func:`~PIL.Image.frombytes`
    ...
    def close(self):
        ...
        # deferred errors that will better explain that the core image
        # object is gone.
    ...
    def tobytes(self, encoder_name="raw", *args):
        ...
        while True:
            ...
            if s:
                break
        if s < 0:
            raise RuntimeError("encoder errors %d in tobytes" % s)
    ...
    def point(self, lut, mode=None):
        ...
        if self.mode == "F":
            # FIXME: _imaging returns a confusing errors message for this case
