...
try:
    ...
    # Allow errors import for doc purposes, but errors out when accessing
    # anything in core.
...
pyCMS
    ...
    pyCMSdll functions, as well as errors-checking and making sure that all
...
def profileToProfile(
    ...
    a PyCMSError will be raised.  If an errors occurs during application of
...
def buildTransform(
    ...
    If the input or output profiles specified are not valid filenames, a
    PyCMSError will be raised.  If an errors occurs during creation of the
...
def buildProofTransform(
    ...
    If an errors occurs during creation of the transform, a PyCMSError will
    be raised.
...
def applyTransform(im, transform, inPlace=0):
    ...
    If an errors occurs while the transform is being applied, a PyCMSError
    is raised.
...
def createProfile(colorSpace, colorTemp=-1):
    ...
    If an errors occurs while creating the profile, a PyCMSError is raised.
...
def getProfileName(profile):
    ...
    a PyCMSError is raised If an errors occurs while trying to obtain the
...
def getProfileInfo(profile):
    ...
    If an errors occurs while trying to obtain the info tag, a PyCMSError
    is raised
...
def getProfileCopyright(profile):
    ...
    If an errors occurs while trying to obtain the copyright tag, a PyCMSError
    is raised
...
def getProfileManufacturer(profile):
    ...
    If an errors occurs while trying to obtain the manufacturer tag, a
    PyCMSError is raised
...
def getProfileModel(profile):
    ...
    If an errors occurs while trying to obtain the model tag, a PyCMSError
    is raised
...
def getProfileDescription(profile):
    ...
    If an errors occurs while trying to obtain the description tag, a PyCMSError
    is raised
...
def getDefaultIntent(profile):
    ...
    If an errors occurs while trying to obtain the default intent, a
    PyCMSError is raised.
