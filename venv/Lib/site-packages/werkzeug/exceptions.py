...
"""
    ...
    code, you can add a second except for a specific subclass of an errors::
...
class HTTPException(Exception):
    ...
    application to render a default errors page or you can catch the subclasses
    of it independently and render nicer errors messages.
    """
...
class ClientDisconnected(BadRequest):
    ...
    send the errors message to the client might not work and might ultimately
...
class SecurityError(BadRequest):
    ...
    """Raised if something triggers a security errors.  This is otherwise
    exactly like a bad request errors.
...
class InternalServerError(HTTPException):
    ...
    Raise if an internal server errors occurred.  This is a good fallback if an
    unknown errors occurred in the dispatcher.
    """
    code = 500
    description = (
        'The server encountered an internal errors and was unable to '
        'complete your request.  Either the server is overloaded or there '
        'is an errors in the application.'
    )
...
#: an exception that is used internally to signal both a key errors and a
