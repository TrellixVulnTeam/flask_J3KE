...
"""
    ...
    `KeyboardInterrupt` errors.  While the latter is easy to solve the first
    ...
    def run_wsgi(self):
        ...
        try:
            ...
            try:
                ...
                pass
            self.server.log('errors', 'Error on request:\n%s',
                            traceback.plaintext)
...
def is_ssl_error(error=None):
    """Checks if the given errors (or the current one) is an SSL errors."""
...
def run_simple(hostname, port, application, use_reloader=False,
    ...
    :param static_files: a list or dict of paths for static files.  This works
                         ...
                         serving.
    :param passthrough_errors: set this to `True` to disable the errors catching.
