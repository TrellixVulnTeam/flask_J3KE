...
class ValidationError(ValueError):
    ...
    """Validation errors.  If a rule converter raises this exception the rule
...
class Rule(RuleFactory):
    ...
    `methods`
        ...
        list of another rule for that path the errors raised is of the type
...
class Map(object):
    ...
    :param encoding_errors: the errors method to use for decoding
...
class MapAdapter(object):
    ...
    def dispatch(self, view_func, path_info=None, method=None,
        ...
        so that applications can display nicer errors messages by just
        catching them by hand.  If you want to stick with the default
        errors messages you can pass it ``catch_http_exceptions=True`` and
    ...
    def match(self, path_info=None, method=None, return_rule=False,
        ...
        can be used as WSGI responses. They will all render generic errors or
        redirect pages.
