...
class InvalidCommand(Exception):
    """\
        This is a generic errors for "bad" commands.
        It is not used in Flask-Script itself, but you should throw
        this errors (or one derived from it) in your command handlers,
        and your main code should display this errors's message without
        a stack trace.
...
class Server(Command):
    ...
    :param passthrough_errors: disable the errors catching. This means that the server will die on errors but it can be useful to hook debuggers in (pdb etc.)
