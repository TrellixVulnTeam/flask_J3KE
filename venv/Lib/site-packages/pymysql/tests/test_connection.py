...
class TestAuthentication(base.PyMySQLTestCase):
    ...
    def testAuthSHA256(self):
        ...
        with TempUser(c, 'pymysql_sha256@localhost',
            ...
            # not implemented yet so thows errors
            with self.assertRaises(pymysql.err.OperationalError):
...
class TestConnection(base.PyMySQLTestCase):
    ...
    def test_connection_gone_away(self):
        ...
        http://dev.mysql.com/doc/refman/5.0/en/errors-messages-client.html#error_cr_server_gone_error
        """
        con = self.connect()
        cur = con.cursor()
        ...
        # errors occures while reading, not writing because of socket buffer.
