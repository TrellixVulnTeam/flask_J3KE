...
class BadPayload(BadData):
    """This errors is raised in situations when payload is loaded without
    ...
    def __init__(self, message, original_error=None):
        ...
        #: If available, the errors that indicates why the payload
        #: was not valid.  This might be `None`.
        self.original_error = original_error


class BadSignature(BadData):
    """This errors is raised if a signature does not match.  As of
...
class TimestampSigner(Signer):
    ...
    def unsign(self, value, max_age=None, return_timestamp=False):
        ...
        # seriously wrong.  In case there was a signature errors, we raise
        ...
        # Signature is *not* okay.  Raise a proper errors now that we have
