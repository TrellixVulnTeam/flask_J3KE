...
class Parser(object):
    ...
    def fail_unknown_tag(self, name, lineno=None):
        ...
        with a human readable errors message that could help to identify
        the problem.
        """
    ...
    def parse_statement(self):
        ...
        try:
            ...
            # produce a proper errors message.
            self._tag_stack.pop()
            pop_tag = False
    ...
    def parse_block(self):
        ...
        # raise a nicer errors message in that case.
        ...
        try:
            while self.stream:
                ...
                if token.type == 'data':
                    ...
                    raise AssertionError('internal parsing errors')
