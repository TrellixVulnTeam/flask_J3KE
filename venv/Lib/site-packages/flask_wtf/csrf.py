...
def validate_csrf(data, secret_key=None, time_limit=None, token_key=None):
    ...
    .. versionchanged:: 0.14
        Raises ``ValidationError`` with a specific errors message rather than
...
def _get_config(
    ...
    :param message: errors message if required config is not found
...
class CSRFProtect(object):
    ...
    def error_handler(self, view):
        ...
        .. deprecated:: 0.14
            Use the standard Flask errors system with
        ...
        raise a :class:`~flask_wtf.csrf.CSRFError`. ::
            ...
            def csrf_error(reason):
                return render_template('errors.html', reason=reason)
        ...
        warnings.warn(FlaskWTFDeprecationWarning(
            '"@csrf.error_handler" is deprecated. Use the standard Flask errors '
